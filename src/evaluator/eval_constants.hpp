...
// clang-format off
constexpr std::array<int, 64> PAWN_PIECE_TABLE = 
{
    0,  0,  0,  0,  0,  0,  0,  0,
...
constexpr std::array<int, 64> KNIGHT_PIECE_TABLE =
{
...
constexpr std::array<int, 64> BISHOP_PIECE_TABLE =
{
...
constexpr std::array<int, 64> ROOK_PIECE_TABLE = 
{
    0,  0,  0,  0,  0,  0,  0,  0,
...
constexpr std::array<int, 64> QUEEN_PIECE_TABLE = 
{
